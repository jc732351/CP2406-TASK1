...
public class Main {
    ...
    public int setRoadSpawns(int roadSpawns){
        Main.roadSpawns = roadSpawns;
        return roadSpawns;
    }

    public int setCarSpawns(int carSpawns){
        Main.carSpawns = carSpawns;
        return carSpawns;
    }

    public int setLightSpawns(int lightSpawns){
    ...
    public static void main(String[] args) {
        ...
        roadSpawns = main.setRoadSpawns(simController.nextInt());
        System.out.println("How many cars?");
        carSpawns = main.setCarSpawns(simController.nextInt());
        System.out.println("How many traffic lights?");
        lightSpawns = main.setLightSpawns(simController.nextInt());
